...
class TestController(unittest.TestCase):
    ...
    def test_osc_broadcast(self):
        ...
        self.assertEqual(eventlog[0][0][0], json.dumps({'method': 'create', 'type': 'broadcasts', 'data': {'data': '123-test-check'}}))
        self.assertEqual(eventlog[1][0][0], json.dumps({'method': 'create', 'type': 'broadcasts', 'data': {}}))
